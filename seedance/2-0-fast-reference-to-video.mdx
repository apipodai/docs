...
description: "Seedance 2.0 Fast Reference to Video is a lower-latency route that uses reference images, video, or audio to guide subjects, motion, visual style, and sound. Media URLs are submitted to asset review before task creation."
